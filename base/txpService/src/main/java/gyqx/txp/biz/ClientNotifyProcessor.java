...
public class ClientNotifyProcessor implements Processor
{
	final static Logger logger = LoggerFactory.getLogger(ClientNotifyProcessor.class);
	public ClientNotifyProcessor()
	{
	...
	public void process(Exchange exchange) throws Exception 
	{
		...
		try{
			List<TaskConfig> taskConfigs= TxpClientConfig.cfg.queryTaskConfigsByTableName(tsn.getTableName()) ;
