<template>
    <el-row :gutter="10" style="height:95%" id="purconfirmViewPrint"  class="printArea" v-show="false">
        <el-row>
        ...
        <el-row>
            <table class="gridtable">
                ...
                <tr v-for="(item ,index) in purconfirm.lstDetail" :key="item.id">
                    ...
                    <td v-if="purconfirm.provId == purconfirm.subProvId">{{salePrice}}</td>
                    <td v-if="purconfirm.provId != purconfirm.subProvId">{{purPrice}}</td>
