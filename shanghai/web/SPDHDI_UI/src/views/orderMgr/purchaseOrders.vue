    ...
    <el-row :gutter="10" style="height:100%;">
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" label-width="80px">
                ...
                <el-form-item>
                    <el-button type="primary" icon="search" v-on:click="getPurchaseList(1)" size="mini" v-if="$permission['0']">查询</el-button>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" icon="edit" size="mini" @click.native="addPurchase" v-if="$permission.add">手工采购</el-button>
                </el-form-item>
            </el-form>
        </el-col>
        <!--列表-->
        <el-table :data="purchaseList" highlight-current-row v-loading="loading" style="width: 100%;" class="table_content">
