<template>
        <el-col :span="24" style="height:100%" id="ec-purc">
            ...
            <el-table :data="purchaseList" highlight-current-row v-loading="loading" style="width: 100%;" fit class="table_content">
                ...
                <el-table-column prop="purchaseComName" label="采购机构" sortable width="200">
                </el-table-column>
            ...
            <el-dialog title="订单确认" @close="onClose" :visible.sync="confirmVisible" :close-on-click-modal="false"  v-loading="diaLoging" width="70%">
                ...
                <el-table :data="purconfimOrder.lstDetail" style="width: 100%;" fit height="350" stripe border @selection-change="sltRowsChange">
                    ...
                    <el-table-column label="规格" prop="goodsGg" width="180" show-overflow-tooltip>
                      ...
                      <el-table-column label="erp编码" prop="erpCode" width="80" show-overflow-tooltip>
                    </el-table-column>
                    ...
                    <el-form label-width="120px">
                        ...
                        <el-col :span="8">
                            <el-form-item label="总金额:">
                                <span>
                                    <i class="fa fa-yen"></i>{{ (purconfimOrder.sumAmount).toFixed(2) }}</span>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="不含税金额:">
                                <span>
                                    <i class="fa fa-yen"></i>{{ (purconfimOrder.sumTaxAmount).toFixed(2) }}</span>
                            </el-form-item>
                        </el-col>
                    </el-form>
                </el-col>
...
export default {
    ...
    methods: {
        ...
        getPurchaseList: function (pIndex) {
            ...
            this.loading = true;
            this.axios.post('/spdHDIService/order/purchase/purchasePage', param).then(res => {
                this.loading = false;
                ...
                purLst.forEach(function (item, index) {
                    if (item.status == 0) {
                        ...
                        if(this.purconfimOrder.subProvId != this.purconfimOrder.provId){
                            ...
                            row.provGoodsErpPrice = (item.salePrice / row.hosScale) || 0;
                        }                        
