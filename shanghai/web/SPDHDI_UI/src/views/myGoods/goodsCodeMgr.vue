<template>
    <div id="goodsCodeMgr" class="fullheight">
            ...
            <el-col :span="20" class="fullheight" style="padding-left: 5px;">
              <el-form :inline="true" label-width="120px">
                 <!-- <el-button  type="primary"  @click="goodEdit(null)">新增</el-button>-->
                      <el-form-item label="名称|规格|ERP" style="margin-bottom:5px;">
						                	<el-input v-model="filters.goodsName" placeholder="名称或规格或erp" ></el-input>
				           	</el-form-item>
                ...
                <el-table highlight-current-row  class="tableheight"
                         :data="goodList" style="width: 100%"
                          ...
                          :default-sort="{prop: 'provGoodsGoodsName', order: 'descending'}" height="outer">
                    <el-table-column  type="selection" :reserve-selection="true" width="55"> </el-table-column>
                    <el-table-column prop="hisCode"   min-idth="85" label="医院商品编号" header-align="center" >
                     </el-table-column>
                   <el-table-column prop="provGoodsErpCode" label="ERP编码" header-align="center"  width="80" >
                    </el-table-column>
                    <el-table-column prop="provGoodsName"   min-idth="85" label="商品名称" header-align="center" width="180"   show-overflow-tooltip >
                    </el-table-column>
					 <el-table-column prop="provGoodsGg"   min-idth="85" label="商品规格" header-align="center" width="150"   show-overflow-tooltip >
                    </el-table-column>
	         <el-table-column prop="provGoodsMade"   min-idth="30" label="产地" header-align="center" width="50"   show-overflow-tooltip >
                    </el-table-column>
            <el-table-column prop="hisUnit"   min-idth="30" label="单位" header-align="center" width="50"   show-overflow-tooltip >
                    </el-table-column>  
              
					 <el-table-column prop="purPrice"   min-idth="85" label="采购价" header-align="center" width="80"   show-overflow-tooltip >
                    </el-table-column>
					 <el-table-column prop="salePrice"   min-idth="85" label="销售价" header-align="center" width="80"   show-overflow-tooltip >
                    </el-table-column>
        ...
        <el-dialog :title="modelTitle" :visible.sync="dialogVisible" :show-close='false'>
                    ...
                    <el-form :model="good" label-width="100px" :rules="editFormRules" ref="editForm" class="el-form-item-nomsg">
                        <el-row>
                            ...
                            <el-form-item label="商品名称" prop="goodsName" >
							 ...
							 <el-col :span="9">
                            <el-form-item label="ERP编码" prop="provGoodsErpCode" >
                                <el-input v-model="good.provGoodsErpCode"  :disabled=true placeholder="ERP编码"></el-input>
                            </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                        ...
                        <el-row>
                            ...
                            <el-row>
                                <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                                        <el-button-group>
                                            <el-button type="primary" class="el-icon-plus" size="mini" @click.native="hosGoodsSelectHanlder">从医院采购目录中选择</el-button>
                                        </el-button-group>
                                </el-col>
                                <template>
                                        <div v-if="willShowFlag" >
                                            <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                                                <el-form :inline="true" label-width="120px">
                                                    <el-form-item label="商品名称">
                                                        <el-input v-model="hosGoodsFilters.goodsName" placeholder="输入商品名称或规格" ></el-input>
                                                    </el-form-item>
                                          ...
                                          <el-table :data="hosGoods" style="width: 100%; height:100%;"
                                               highlight-current-row

                                               @current-change="handleCurrentChange4Row"
                                               fit  border>
                                              <el-table-column prop="code" label="医院商品编码" >
                                              </el-table-column>
                                               <el-table-column prop="goodsName" label="医院商品名称" >
                                              </el-table-column>
                                               <el-table-column prop="goodsGg" label="医院商品规格" >
                                              </el-table-column>
                                               <el-table-column prop="made" label="产地" >
                                              </el-table-column>
                                               <el-table-column prop="unit" label="单位" >
                                              </el-table-column>
                                              <el-table-column prop="mfrsName" label="生产厂商" >
                                              </el-table-column>
                                           </el-table>
                                            <el-col :span="24" class="toolbar">
                                                <el-pagination @size-change="handleHosGoodsSizeChange" @current-change="handleHosGoodsCurrentChange" :current-page="hosGoodsPage" :page-sizes="[10, 20, 30, 50]" :page-size="hosGoodsPageSize" layout="total, sizes, prev, pager, next" :total="hosGoodsTotal" style="float:right;" small>
                                                </el-pagination>
                                            </el-col>
                                        </div>
                                </template>
                            ...
                            <el-row>
                                <el-col>
                                    <el-form-item label="医院产品名称"  prop="hisName" :error="errors.hisNameErr">
                                        <el-input v-model="good.hisName" :disabled=true ></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
                                ...
                                <el-form-item label="医院产品编码"  prop="hisCode" :error="errors.hisCodeErr">
                                    <el-input v-model="good.hisCode" :disabled=true ></el-input>
                                </el-form-item>
                                </el-col>
                                <el-col :span="12">
                            ...
                            <el-col :span="12">
                                <el-form-item label="集配商向二级供应商采购价" prop="purPrice" :error="errors.purPriceErr">
                            ...
                            <el-row>
                                ...
                                <el-col :span="12">
                                <el-form-item label="比率(医院/供应商)" prop="unitRate" :error="errors.unitRateErr">
                            ...
                            <el-row>
                                ...
                                <el-form-item label="医保编码" prop="miCode">
                                    <el-input v-model="good.miCode" ></el-input>
                                </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                <el-form-item label="医保名称" prop="miName">
                                    <el-input v-model="good.miName" ></el-input>
                                </el-form-item>
                                </el-col>
                            </el-row>
                        </el-form>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click.native="dialogVisible = false, willShowFlag =false" >取消</el-button>
...
export default {
  data () {
    return {
      ...
      editFormRules: {
        hisCode: [
          { required: true, message: '医院产品编码需从采购目录中选择', trigger: 'blur' }
        ],
        hisName: [
          { required: true, message: '医院产品名称需从采购目录中选择', trigger: 'blur' }
        ],
        salePrice: [
  ...
  methods: {
    ...
    handleSizeChange (val) {
      this.hosGoodsPageSize = val
      this.getHosListsByUnit(this.page)
    },

    handleHosGoodsCurrentChange (val) {
      this.hosGoodsPage = val
      this.getHosGoodsList(this.page)
    },
    handleHosGoodsSizeChange (val) {
      this.pageSize = val
      this.getHosGoodsList(this.page)
    },
    ...
    getProvGoodList: function (pIndex) {
      ...
      var param = { orderBy: '', queryObject: { goodsName: this.provGoodsFilters.goodsName}, page: this.provGoodsPage, rows: this.provGoodsPageSize }
      this.loading = true
