       ...
       <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
            <TBODY>
              <TR>
                ...
                <TD width="28%"><font color="#0000FF" size=1>单号：<SPAN >{{ distrBill.billId }}</SPAN></font></TD>
       ...
       <TABLE border=1 cellSpacing=0 cellPadding=1 width="100%" style="border-collapse:collapse" bordercolor="#333333">
            <thead>
                  ...
                  <tr>
                          ...
                          <th width="11%"><font  size=1>产品名称</font></th>
                          <th width="9%"><font  size=1>规格型号</font></th>
                          <th width="10%"><font  size=1>生产企业</font></th>
                          ...
                          <th width="10%"><font  size=1>注册证</font></th>
                    </tr>
            </thead>
            <tbody>
                      <tr v-for="(item,index) in distrBill.distrBillList" :key="item.id">
                          ...
                          <td  align="center" style="letter-spacing:1px"><font  size=1>{{item.provGoodsErpName}}</font></td>
                          <td  align="center" style="letter-spacing:1px"><font  size=1>{{item.goodsGg}}</font></td>
                          <td  align="center" style="letter-spacing:1px"><font  size=1>{{item.goodsMrfsName}}</font></td>
                          <td  align="center" style="letter-spacing:1px"><font  size=1>{{item.batchCode}}</font></td>
                          <td  align="center" style="letter-spacing:1px"><font  size=1>{{item.expdtEndDate | dateFormat('YYYY-MM-DD')}}</font></td>
                          <td  align="center" style="letter-spacing:1px"><font  size=1>{{item.productDate | dateFormat('YYYY-MM-DD')}}</font></td>
                          <td  align="center" style="letter-spacing:1px"><font  size=1>{{item.sendUnit}}</font></td>
                          <td  align="center" style="letter-spacing:1px"><font  size=1>{{item.sendQty}}</font></td>
                          <td  align="center" style="letter-spacing:1px"><font  size=1>{{item.subSendPrice}}</font></td>
              ...
              <TBODY>
                   <tr>
                            <td colspan=3 style=" border:0px" align="left"> 
                                  <span ><font color="#0000FF" size=1>制单人：{{distrBill.fillterName}};</font></span>
                            </td>
                            <td colspan=3  style=" border:0px" align="left"> 
                                  <span ><font color="#0000FF" size=1>复核员：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></span>
                            </td>
                            <td colspan=3 style=" border:0px" align="left"> 
                                  <span ><font color="#0000FF" size=1> 联系电话：{{distrBill.tel}}</font></span>
                            </td>
                            <td colspan=3 style=" border:0px"  align="left"> 
...
export default {
    ...
    methods: {
        print(distrBill){
            ...
            setTimeout(this.callLodop,2000) 
