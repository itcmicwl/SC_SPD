...
<div>
    <el-row :gutter="10" v-loading="pageLoading" style="height:100%">
        ...
        <el-table :data="distrBill.distrBillList" style="width: 100%;" fit class="table_content" border>
                    ...
                    <el-table-column prop="subSendPrice" label="采购单价">
                    </el-table-column>
                    <el-table-column prop="sendPrice" label="配送单价">
                    </el-table-column>
                    <el-table-column prop="sendQty" label="配送数量">
                    </el-table-column>
                    <el-table-column prop="sendUnit" label="配送计量单位" width="90">
                    </el-table-column>
                    <el-table-column prop="hosQty" label="医院数量" width="90">
                    </el-table-column>
                    <el-table-column prop="hosUnit" label="医院计量单位" width="90">
                    </el-table-column>
                </el-table>
   ...
   <distBillViewPrint ref="printD"></distBillViewPrint>
</div> 
</template>
