<template>
  <div id="provLZXYS" style="height:100%">
    ...
    <el-table highlight-current-row ref="cnsTable" class="provIncorrupt-tableheight" :row-class-name="tableRowClassName"
  ...
  export default {
    data () {
      ...
      return {
        ...
        baseURL: '/spdHDIService/provIncorruptAgrmt',
...
<style>
  ...
  .queryFormClass{
    padding-top: 2px;
    height: 30px;
    -webkit-box-shadow: 0px 0px 3px 0px #a9a1a1 inset;
