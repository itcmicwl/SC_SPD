<template>
    <div  style="height: 100%;">	
        ...
        <!--列表-->	
        <!--Excel导入界面-->
        <el-dialog title="从Excel中导入供应商模板" close="onClose" v-model="importExcelVisible" :show-close='true' :close-on-press-escape='true' :close-on-click-modal="true">
                <template>       
                        <div>
                            <el-upload
                            class="upload-demo"
        ...
        <el-dialog title="供应商查询结果" close="onClose" v-model="goodImportErrorsVisible" :close-on-click-modal="true" :show-close='true'  :close-on-press-escape='true'  size="full">
            <template>
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    ...
                    <el-tab-pane label="供应商证照" name="second">
                        <el-table ref="multipleTable" :data="goodImportErrors"  border tooltip-effect="dark" style="width: 100%">
                            <el-table-column type="index" label="序号"  align="center"></el-table-column>
                            <el-table-column prop="ksbm" label="供应商编码"></el-table-column>
                            <el-table-column prop="ksmc" label="供应商名称" show-overflow-tooltip> </el-table-column>
                    ...
                    <div class="exportDiv">
                            ...
                            <el-button type="primary" @click="exportExcel('provInfo')" :loading="editLoading" size="small">导出供应商信息</el-button>
                        </div>
                </el-tabs>
        ...
        <!--Excel导出下载界面-->
        <el-dialog title="导出供应商模板" close="onClose" v-model="exportExcelVisible" :show-close='true' :close-on-press-escape='true' :close-on-click-modal="true">
