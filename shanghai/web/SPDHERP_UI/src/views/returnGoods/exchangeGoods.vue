        ...
        <el-col :span="24" style="height: 100%">
            <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                <el-form :inline="true" :model="filters" ref="provInfoForm">
                    ...
                    <el-button-group>
                        <el-button type="primary" v-on:click="getExchangeGoodsList(1)" >查询</el-button>
                        <el-button type="primary" v-on:click="resetProvInfo('provInfoForm')" >重置</el-button>
                        <el-button type="success" @click="addExchangeGoods()" >新增</el-button>
                    </el-button-group>
                </el-form>
            </el-col>
            <!--列表-->
            <template>
                <el-table :data="exchangeGoodsList" highlight-current-row v-loading="loading" style="width: 100%;" border fit height="outter" class="exchangeGoods-tableheight">
            ...
            <!-- 编辑界面 -->
            <el-dialog title="添加换货登记单"   close="onClose"  :visible.sync="editFormVisible" :close-on-click-modal="false" >
                <el-form :model="exchangeGoods" label-width="120px" ref="editForm" class="el-form-item-nomsg">
                    ...
                    <el-row>
                        <el-form-item label="换货数量：" prop="excQty">
                            <el-input v-model="exchangeGoods.excQty"  style="width: 70%;" placeholder="请输入灭菌批号"></el-input>
                        </el-form-item>
                    </el-row>
                </el-form>
                <div slot="footer" class="dialog-footer exchangeGoods-button-align">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 获取医院换货登记单列表
            getExchangeGoodsList: function (pIndex) {
                this.page = pIndex;
                var param = {
                    orderBy: "",
                    queryObject: {
                ...
                this.loading = true;
                this.axios.post('/spdHERPService/returnGoods/exchangeGoodsList/listByPage', param).then(res => {
                    this.loading = false;
                    this.exchangeGoodsList = res.data.data.data;
            ...
            handleCurrentChange(val) {
                this.page = val;
                this.getExchangeGoodsList(this.page);
            },
            ...
            editSubmit: function () {
                ...
                this.axios.post("/spdHERPService/returnGoods/exchangeGoodsList/add", this.exchangeGoods).then(res => {
...
<style>
    #exchangeGoodsDiv .exchangeGoods-tableheight {
        height: calc(100% - 85px);
    }
    #exchangeGoodsDiv .exchangeGoods-button-align{
        text-align: center;
    }
    #exchangeGoodsDiv{
        height: 100%;
    }
    #exchangeGoodsDiv .el-dialog--small {
        width: 658px;
    }
</style>
