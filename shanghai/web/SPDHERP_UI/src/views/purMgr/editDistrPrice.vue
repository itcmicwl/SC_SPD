<template>
    <el-row :gutter="10" v-loading="pageLoading" style="height:100%" id="billConv">
        ...
        <!--列表-->
        <el-table :data="distrBill.distrBillList" style="width: 100%;" height="55%" fit class="table_content" border>
...
export default {
    ...
    methods: {
        ...
        submitDistr(){
            ...
            this.pageLoading = true;
             this.axios.post('/spdHERPService/orderMgr/distrBill/updatePrice_hosBatch/',this.distrBill).then(res => {
                this.pageLoading = false;
