...
<template>
    <div  style="height: 100%;" id="centerStockOutQuery" @keyup.enter="getGoodsList(1)">
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px; padding-left:5px; height: 99%;">
            ...
            <template>
                <el-table ref="goodsTable" :data="goods"  row-key='id'
                    ...
                    <el-table-column prop="billDate"  sortable header-align="center" min-width="85" label="入库日期" >
                      <template slot-scope="scope">
                             {{scope.row.billDate | dateFormat('YYYY-MM-DD')}}
                        </template>
                    </el-table-column>
					<el-table-column prop="billId" header-align="center" label="入库单号" width="110"></el-table-column>
                    ...
                    <el-table-column prop="outDeptName" align="center" label="入库科室" min-width="80" ></el-table-column>
                    ...
                    <el-table-column prop="made" align="center" min-width="60" label="产地" ></el-table-column>
                    ...
                    <el-table-column prop="subProvName" sortable header-align="center"  label="供应商" min-width="200"></el-table-column>
        ...
        <centerStockOutQueryPrint ref="purPrintD" ></centerStockOutQueryPrint>
    </div>

</template>
<script>
import centerStockOutQueryPrint from './components/centerStockOutQueryPrint';
import $ from 'jquery';
...
import '../../common/third/tableExport/jquery.base64';
    export default {
        data() {
            return {
                ...
                filters: { 
                    ...
                    sDate:[],
                    provType: '',
                    arrStatus:[30,60,70]  //30 记账   60 二级已入库   70已结算
                },
                pickerOptions2: {
                    shortcuts: [{
                        text: '最近一周',
      ...
      /*  watch:{
        ...
        components: { centerStockOutQueryPrint },
        methods: {
             ...
             print () {
                this.$refs.purPrintD.print(this.goodsForPrint,this.filters.sDate,this.filters.eDate)
            },
            ...
            exportExcel:function(){
               let tableHtml = '<table><thead><tr><th>序号</th>'
                +'<th>入库日期</th><th>入库单号</th><th>配送单号</th>'
                +'<th>医疗机构名称</th><th>入库科室</th>'
                +'<th>ERP编码</th><th>商品名</th><th>商品规格</th>'
                +'<th>厂家</th><th>产地</th><th>单位</th><th>批号</th>'
            ...
            getGoodsList: function (pIndex) {
                ...
                this.loading = true;
                this.axios.post('/spdHERPService/reportAnalysis/reportStatistics/getCenterStockOutQuery', param).then(res => {
                    this.loading = false;
                    if (res.data.code == "0") {
