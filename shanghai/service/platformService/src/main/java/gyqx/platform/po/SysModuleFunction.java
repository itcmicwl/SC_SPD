...
public class SysModuleFunction implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "SysModuleFunction [" +" id=" +  id   +", moduleId=" +  moduleId   +", code=" +  code   +", ename=" +  ename   +", cname=" +  cname   +", remark=" +  remark   +", uxid=" +  uxid   +", mt=" +  mt   +", version=" +  version   
			 + "]";
	}
