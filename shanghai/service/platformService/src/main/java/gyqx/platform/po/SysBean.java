...
*/
@Table(name="sys_bean")
public class SysBean implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "SysBean [" +" id=" +  id   +", packageName=" +  packageName   +", ename=" +  ename   +", cname=" +  cname   +", remark=" +  remark   +", uxid=" +  uxid   +", mt=" +  mt   +", version=" +  version   
			 + "]";
	}
