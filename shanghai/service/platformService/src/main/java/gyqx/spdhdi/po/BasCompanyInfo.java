...
public class BasCompanyInfo implements IBean {
	...
	public String toString() {
		return "BasCompanyInfo [id=" + id + ", code=" + code + ", cname=" + cname + ", anotherName=" + anotherName
				+ ", shortPinyin=" + shortPinyin + ", regCode=" + regCode + ", jyxkCode=" + jyxkCode + ", nsrsbCode="
				+ nsrsbCode + ", kind=" + kind + ", agentName=" + agentName + ", productCode=" + productCode
				+ ", recordCard=" + recordCard + ", legal=" + legal + ", address=" + address + ", linkman=" + linkman
				+ ", contactWay=" + contactWay + ", contactFax=" + contactFax + ", logo=" + logo + ", postCode="
				+ postCode + ", email=" + email + ", remark=" + remark + ", erpCode=" + erpCode + ", isSupply="
				+ isSupply + ", isThreeInOne=" + isThreeInOne + ", masterCode=" + masterCode + ", flag=" + flag
				+ ", province=" + province + ", city=" + city + ", area=" + area + ", areaCode=" + areaCode + ", uxid="
