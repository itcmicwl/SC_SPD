...
public class ServiceAndControllerCodeGenTest {
	...
	public void outputPoAllCode() throws Exception {
		...
		//String subSystem = "gyqx.platform";
		// 源代码输出目录
		//String outputPath= "D:/Workspaces/eclipse/spdHDI/src/main/java";//"D:/Workspaces/eclipse/platform/src/main/java";
		//系统分组名称
		String groupName = "settleCenter";

		// 需要选择的表，空表示选择全部
		String sFilters = "hos_out_balance,hos_out_balance_detail";//"bas_barcode_rules";//"";
	...
	public void outputQueryBeanCode() throws Exception
	{
		...
		// 查询条件对象名称
		String queryBeanName = "MenuItem";
		//查询结果对象名称
		String queryResultBeanName = "MenuItem";
