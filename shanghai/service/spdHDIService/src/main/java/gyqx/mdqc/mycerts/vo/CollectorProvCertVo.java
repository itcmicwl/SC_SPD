...
public class CollectorProvCertVo extends CollectorProvCert {
	private static final long serialVersionUID = 1L;
	
	private List<CollectorProvCertificateVo> collectorProvCertificates;
	
	public List<CollectorProvCertificateVo> getCollectorProvCertificates() {
		return collectorProvCertificates;
	}

	public void setCollectorProvCertificates(List<CollectorProvCertificateVo> collectorProvCertificates) {
		this.collectorProvCertificates = collectorProvCertificates;
	}
