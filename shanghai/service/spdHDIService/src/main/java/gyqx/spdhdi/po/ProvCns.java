...
*/
@Table(name="prov_cns")
public class ProvCns implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "ProvCns [" +" id=" +  id   +", provId=" +  provId   +", hosId=" +  hosId   +", filePathWts=" +  filePathWts   +", expdtBeginDate=" +  expdtBeginDate   +", expdtEndDate=" +  expdtEndDate   +", uxid=" +  uxid   +", fillDate=" +  fillDate   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
