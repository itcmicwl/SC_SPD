 ...
 * 订单收货温湿度明细
*/
@Table(name="receive_bill_humiture_list")
public class ReceiveBillHumitureList implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	 ...
	 * 收货时间
	*/
	@Column(name="receive_measure_date")
	@Title("收货时间")
