...
public class ProvRegGoodsInfoQR 
{
	/**
	 * 供应商ID
	*/
	...
	*/
	...
	public String toString() {
		return "ProvRegGoodsInfoQR ["  +" provId=" +  provId    +", certificateId=" +  certificateId    +", goodsId=" +  goodsId    +", fillDate=" +  fillDate    +", goodsName=" +  goodsName    +", productName=" +  productName    +", certificateCode=" +  certificateCode    +", mfrsId=" +  mfrsId    +", isOldInfo=" +  isOldInfo    +", expdtBeginDate=" +  expdtBeginDate    +", expdtEndDate=" +  expdtEndDate    +", regKind=" +  regKind    +", goodsGg=" +  goodsGg    +", shortPinyin=" +  shortPinyin    +", made=" +  made    +", unit=" +  unit    +", packeage=" +  packeage    +", mfrsCode=" +  mfrsCode    +", kindCode=" +  kindCode    +", masterCode=" +  masterCode    +", erpCode=" +  erpCode    +", hitCode=" +  hitCode    +", hitPrice=" +  hitPrice    +", spdGoodsCode=" +  spdGoodsCode    +", fieldCode2=" +  fieldCode2    +", fieldCode3=" +  fieldCode3    +", fieldCode4=" +  fieldCode4    +", lbsx=" +  lbsx    +", flag=" +  flag    +", kind68code=" +  kind68code    +", code=" +  code   
			 + "]";
	}
