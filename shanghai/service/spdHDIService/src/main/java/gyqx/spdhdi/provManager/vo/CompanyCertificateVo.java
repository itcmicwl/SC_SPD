...
public class CompanyCertificateVo {
	...
	private BasCompanyCertificateImage basCompanyCertificateImage;
	...
	public BasCompanyCertificateImage getBasCompanyCertificateImage() {
		return basCompanyCertificateImage;
	}

	public void setBasCompanyCertificateImage(BasCompanyCertificateImage basCompanyCertificateImage) {
		this.basCompanyCertificateImage = basCompanyCertificateImage;
	}
	...
	public String toString() {
		return "CompanyCertificateVo [id=" + id + ", companyId=" + companyId + ", certKind=" + certKind + ", certCode="
				...
				+ ", version=" + version + ", basCompanyCertificateImage=" + basCompanyCertificateImage + "]";
	}
