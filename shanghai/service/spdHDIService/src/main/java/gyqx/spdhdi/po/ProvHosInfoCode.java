 ...
 * 供应商医院内部编码设置
*/
@Table(name="prov_hos_info_code")
public class ProvHosInfoCode implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "ProvHosInfoCode [" +" id=" +  id   +", provId=" +  provId   +", hosId=" +  hosId   +", erpCode=" +  erpCode   +", salemanId=" +  salemanId   +", salemanCode=" +  salemanCode   +", fillDate=" +  fillDate   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
