 ...
 * 销售代表
*/
@Table(name="prov_sales_rep")
public class ProvSalesRep implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "ProvSalesRep [" +" id=" +  id   +", provId=" +  provId   +", hosId=" +  hosId   +", salesName=" +  salesName   +", phoneNum=" +  phoneNum   +", filePath=" +  filePath   +", expdtBeginDate=" +  expdtBeginDate   +", expdtEndDate=" +  expdtEndDate   +", uxid=" +  uxid   +", fillDate=" +  fillDate   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
