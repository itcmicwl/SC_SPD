...
public interface IDistrBillService 
{
	...
	//-------------------------------------四川进院后修改价格-------------------------------------------------
	boolean updatePrice_hosBatch(DistrBillVo distrBill) throws Exception;
	QueryResult<DistrBillVo> listByPage4Simple(QueryInfo<DistrBillVo> queryInfo) throws Exception;	
