...
public class ProvGoodsInfo implements IBean
{
	...
	*/
	...
	public String toString() {
		return "ProvGoodsInfo [" +" id=" +  id   +", provId=" +  provId   +", code=" +  code   +", goodsName=" +  goodsName   +", shortPinyin=" +  shortPinyin   +", goodsGg=" +  goodsGg   +", made=" +  made   +", mfrsId=" +  mfrsId   +", unit=" +  unit   +", packeage=" +  packeage   +", masterCode=" +  masterCode   +", mfrsCode=" +  mfrsCode   +", kindCode=" +  kindCode   +", kind68code=" +  kind68code   +", erpCode=" +  erpCode   +", hitCode=" +  hitCode   +", hitPrice=" +  hitPrice   +", spdGoodsCode=" +  spdGoodsCode   +", fieldCode2=" +  fieldCode2   +", fieldCode3=" +  fieldCode3   +", fieldCode4=" +  fieldCode4   +", certificateCode=" +  certificateCode   +", lbsx=" +  lbsx   +", remark=" +  remark   +", flag=" +  flag   +", brand=" +  brand   +", uxid=" +  uxid   +", fillDate=" +  fillDate   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
