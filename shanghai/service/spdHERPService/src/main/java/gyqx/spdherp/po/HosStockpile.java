 ...
 * 医院库存信息
*/
@Table(name="hos_stockpile")
public class HosStockpile implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "HosStockpile [" +" id=" +  id   +", hosId=" +  hosId   +", stocId=" +  stocId   +", shelfCode=" +  shelfCode   +", hosGoodsId=" +  hosGoodsId   +", qty=" +  qty   +", price=" +  price   +", batchNo=" +  batchNo   +", batchId=" +  batchId   +", expdtEndDate=" +  expdtEndDate   +", sterilizationCode=" +  sterilizationCode   +", sterilizationEndDate=" +  sterilizationEndDate   +", sterilizationDate=" +  sterilizationDate   +", inTime=" +  inTime   +", barcode=" +  barcode   +", stocKind=" +  stocKind   +", bigBatchCode=" +  bigBatchCode   +", uniqueCode=" +  uniqueCode   +", secCode=" +  secCode   +", hibcCode=" +  hibcCode   +", packetCode=" +  packetCode   +", isPacket=" +  isPacket   +", uniqueKind=" +  uniqueKind   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
