 ...
 * 出库单唯一码明细
*/
@Table(name="out_stock_unique_code")
public class OutStockUniqueCode implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "OutStockUniqueCode [" +" id=" +  id   +", pid=" +  pid   +", billId=" +  billId   +", pRowId=" +  pRowId   +", provId=" +  provId   +", goodsId=" +  goodsId   +", goodsBatchId=" +  goodsBatchId   +", inPrice=" +  inPrice   +", inTime=" +  inTime   +", uniqueCode=" +  uniqueCode   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
