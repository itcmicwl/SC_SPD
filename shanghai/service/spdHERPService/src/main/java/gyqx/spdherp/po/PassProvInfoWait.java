 ...
 * 供应商信息接口待同步
*/
@Table(name="pass_prov_info_wait")
public class PassProvInfoWait implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "PassProvInfoWait [" +" id=" +  id   +", spdCode=" +  spdCode   +", provSysCode=" +  provSysCode   +", provErpCode=" +  provErpCode   +", provName=" +  provName   +", provErpCode1=" +  provErpCode1   +", provErpName=" +  provErpName   +", provSimpleName=" +  provSimpleName   +", remark=" +  remark   +", save=" +  save   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
