 ...
 * SPD订单返回明细接口表待同步
*/
@Table(name="pass_distr_bill_list_wait")
public class PassDistrBillListWait implements IBean
{
	/**
	 * ID
	*/
