 ...
 * 商品配送价明细接口历史数据
*/
@Table(name="pass_pro_goods_price_sheet_d")
public class PassProGoodsPriceSheetD implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "PassProGoodsPriceSheetD [" +" id=" +  id   +", pId=" +  pId   +", hosErpCode=" +  hosErpCode   +", hosName=" +  hosName   +", distrPrice=" +  distrPrice   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
