 ...
 * 商品配送价主表接口历史数据
*/
@Table(name="pass_pro_goods_price_sheet")
public class PassProGoodsPriceSheet implements IBean
{
	/**
	 * ID
	*/
	...
	*/
	...
	public String toString() {
		return "PassProGoodsPriceSheet [" +" id=" +  id   +", spdCode=" +  spdCode   +", provSysCode=" +  provSysCode   +", provErpCode=" +  provErpCode   +", provName=" +  provName   +", provGoodsErpCode=" +  provGoodsErpCode   +", provGoodsErpName=" +  provGoodsErpName   +", distrPrice=" +  distrPrice   +", lastUpdateDatetime=" +  lastUpdateDatetime   +", version=" +  version   
			 + "]";
	}
